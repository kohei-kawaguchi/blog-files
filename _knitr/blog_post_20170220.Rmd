...
**そうした「非近経教員」をのぞいてみたところ対象教員数は28名となりました。阪大論文の42名はずいぶんと多様な教員を含んだ数字だったようです。**ここでは「近経教員」をかなり広く取っています。計算に必要なデータとコードもGitHubで公開してあるので、頑健性を確認されたい方はそちらを利用してください。東京大学の経済学研究科についても同じような計算を[Unrepresentative Agent さんがブログで試みています](http://unrepresentativeagent.blogspot.jp/2017/01/why-median-person-at-tokyo-university.html)が、ここでもHPに記載されている64名の教員中「近経教員」と呼べるのは38名程度ではないかと結論づけています。
